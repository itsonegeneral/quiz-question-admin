    ...
    <div class="container">
      ...
      <b-card class="main-card">
        ...
        <div>
          ...
          <b-input v-model="quizoption.rewardcoins" placeholder="eg.1000" class="number-input col-sm-12 col-md-4" type="number" min="0"/>
        </div>

          <div>
          <label > Entry Coins</label>
          <b-input v-model="quizoption.entrycoins" class="number-input col-md-4 col-sm-12" type="number" min="0" placeholder="0 for free"/>
        </div>

          <div>
            <span>
              <label >Time for each question</label>
              <b-input v-model="quizoption.gametime" class="number-input col-md-4 col-sm-12" type="number" min="0" placeholder="0 for no time limit (in seconds)"/>
              <br>
            </span>
            <span>
              <label >No of questions</label>
              <b-input v-model="quizoption.questionsize" class="number-input col-md-4 col-sm-12" type="number" min="5" max="30" placeholder="Min 5"/>
              <br>
            </span>
          </div>
          <div>
